...
#' data or leader-dyad-year data.
#'
#' @return \code{add_lwuf()} takes a leader-year or leader-dyad-year data frame and adds estimates of leader willingness to use force,
