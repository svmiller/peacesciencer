...
#'
#' @description \code{add_lwuf()} allows you to add estimates of leader willingness to use force to leader-year
#' data.
#'
#' @return \code{add_lwuf()} takes a leader-year data frame and adds estimates of leader willingness to use force,
#' as generated by Carter and Smith (2020).
#'
#' @details Right now, only leader-year data are supported. See \code{lwuf} for more information, but I'll copy-paste it here
#' too.
#'
#' The letter published by Carter and Smith (2020) contains more information as to what these thetas refer.
...
#'
#' The authors construct and include all these measures, though their analyses suggest "M2" is the best-performing measure. You
#' should probably consider using \code{theta2_mean} as your default estimate of leader willingness to use force in leader-year
#' analyses.
#'
