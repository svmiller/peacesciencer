...
#'
#'
#' @return \code{add_sdp_gdp()} takes a (dyad-year, leader-year, leader-dyad-year, state-year) data frame and adds information
#' about the estimated gross domestic product (in 2011 USD) for that year, the estimated population in that year, the GDP per
#' capita in that year, and what Anders, Fariss and Markowitz term the "surplus domestic product" in that year.
#' If the data are dyad-year (leader-dyad-year), the function
...
#' If the data are state-year (or leader-year), the function returns four additional columns to the original data that contain that same information
...
#' Make sure a recognized function (or data created by that function) appear at the top
