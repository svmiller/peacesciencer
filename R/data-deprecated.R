...
#' may be deprecated either by insistence of the data set's author, or because
#' the data themselves are legacy data no longer in active demand or use in the
