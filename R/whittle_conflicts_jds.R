...
#'
#' @description  \code{whittle_conflicts_jds()} is in a class of do-it-yourself functions for coercing (i.e. "whittling") conflict-year
...
#'
#' @return \code{whittle_conflicts_jds()} takes a dyad-year data frame or leader-dyad-year data frame with a declared conflict attribute type and, grouping by the
...
#'
#' This really should be the absolute last exclusion rules a researcher uses. It's a "nuclear option", if you will.
#' Assuming you've run other case exclusion rules to isolate onsets and severe disputes, what remains at the end should
#' be duplicates that are functionally equivalent observations. Your data cannot have duplicates, and these remaining
