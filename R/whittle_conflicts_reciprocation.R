...
#'
#' @return \code{whittle_conflicts_reciprocation()} takes a dyad-year data
...
#' state on Side B does. However, scholars should *not* interpret that as
#' the absence of militarized responses. In a forthcoming article in
#' *Journal of Conflict Resolution*, Doug Gibler and I make the case that
