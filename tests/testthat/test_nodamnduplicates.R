...
test_that("Dyad-year additions do not create duplicates", {
  ...
  expect_equal(nrow(cow_ddy), nrow(cow_ddy %>% add_minimum_distance()))
  ...
  expect_equal(nrow(create_dyadyears(system = "gw")), nrow(create_dyadyears(system = "gw") %>% add_capital_distance()))
...
test_that("State-year additions do not create duplicates", {
  ...
  expect_equal(nrow(create_stateyears(system = "gw")), nrow(create_stateyears(system="gw") %>% add_capital_distance()))
