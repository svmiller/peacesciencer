...
\texttt{\{peacesciencer\}}'s functions work out of the box, though it works best with one additional package. This is \texttt{\{tidyverse\}}, itself a set of packages that share a common form and design (Wickham \& Grolemund, 2017). \texttt{\{peacesciencer\}} functions make considerable use of the component packages of \texttt{\{tidyverse\}} but installing and loading \texttt{\{tidyverse\}} will allow the researcher to make quicker use of \texttt{\{peacesciencer\}}'s functionality. A user can open an R session and install both packages as follows.
