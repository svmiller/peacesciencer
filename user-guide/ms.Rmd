...
Users can also calculate peace-years for these conflicts with `add_peace_years()` by using the pipe to pass forward the data set and applying the `add_peace_years()` function to it.[^onpy]
