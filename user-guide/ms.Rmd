...
[^poundsign]: R users will recognize that pound signs (`#`) allow for commenting code. Users new to R should understand its use here is primarily for exposition of what the code snippets in this manuscript are doing.
